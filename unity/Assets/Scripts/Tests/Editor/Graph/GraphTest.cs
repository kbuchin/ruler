...
namespace Algo.Graph.Tests
{
    [TestFixture]
    public class GraphTest
    {
        private List<Vector2> m_complete4pos;
        private Graph m_complete4;
        private List<Vector2> m_level2pos;


        public GraphTest()
        {
            m_complete4pos = new List<Vector2>() { new Vector2(0, 0), new Vector2(1, 0), new Vector2(0, 1), new Vector2(1, 1) };
            m_complete4 = new Graph(m_complete4pos);
            m_complete4.MakeCompleteGraph();

            m_level2pos = new List<Vector2>() {
        ...
        public void GraphLengthTest()
        {
            ...
            Assert.AreEqual(expected, m_complete4.LengthOfAllEdges());
        }

        [Test]
        public void MSTTest()
        {
            var mst = new Graph(m_complete4pos);
