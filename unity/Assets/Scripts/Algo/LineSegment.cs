...
namespace Algo
{
    public class LineSegment
    {
        ...
        public FloatInterval XInterval
        {
            get
            {
                return new FloatInterval(m_point1.x, m_point2.x);
            }
        }
        ...
        public FloatInterval YInterval
        {
            get
            {
                return new FloatInterval(m_point1.y, m_point2.y);
            }
        }
        ...
        public float X(float a_y)
        {
            ...
            {
                throw new AlgoException("X-value requested for y:" + a_y + "not in Y-interval" + YInterval.ToString());
            }
        }
        ...
        public float Y(float a_x)
        {
            ...
            {
                throw new AlgoException("Y-value requested for x:"+ a_x + "not in x-interval"+ XInterval.ToString());
            }
        }
