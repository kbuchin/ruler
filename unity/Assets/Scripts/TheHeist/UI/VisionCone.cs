namespace TheHeist
{
    ...
    {
        public static Polygon2D Vision(Polygon2D polygon, Vector2 x, Vector2 d)
        {
            return Vision(new Polygon2DWithHoles(polygon), x, d);
        }

        public static Polygon2D Vision(Polygon2DWithHoles polygon, Vector2 x, Vector2 d)
        {
            ...
            Vector2 coneLine1 = Rotate(d, 30);
            Vector2 coneLine2 = Rotate(d, -30);
