...
public class GraphDrawer : MonoBehaviour
{
    ...
    private void DrawEdges()
    {
        ...
        {
            GL.Color(m_color);
            GL.Vertex3(edge.Fromvertex.x, edge.Fromvertex.y, 0);
            GL.Vertex3(edge.Tovertex.x, edge.Tovertex.y, 0);
        }
        GL.End();
    }
    ...
    private void DrawVertices()
    {
        ...
        foreach (Vector2 vertex in m_graph.Vertices)
        {
            ...
            for (float a = 0; a < (2* Mathf.PI + step); a += step)
            {
                ...
                GL.Vertex3(((Mathf.Cos(a) * Pointradius /  transform.localScale.x) + vertex.x),  ((Mathf.Sin(a) * Pointradius / transform.localScale.y) + vertex.y), 0);
            }
        }
        GL.End();
    }
